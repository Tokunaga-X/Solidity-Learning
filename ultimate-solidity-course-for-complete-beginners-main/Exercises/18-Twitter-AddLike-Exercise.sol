...
contract Twitter {
    ...
    function likeTweet(uint16 _id, address author) external {
        tweets[author][_id].likes += 1;
    }

    function unLikeTweet(uint16 _id, address author) external {
        require(tweets[author][_id].likes > 0, "there is not likes");
        tweets[author][_id].likes -= 1;
    }
